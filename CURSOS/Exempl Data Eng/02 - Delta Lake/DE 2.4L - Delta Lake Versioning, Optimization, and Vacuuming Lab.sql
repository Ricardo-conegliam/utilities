...
-- MAGIC %scala
-- MAGIC
-- MAGIC val x=spark.read.parquet("dbfs:/user/ricardo.conegliam@databricks.com/dbacademy/dewd/2.4l/2_4l.db/beans/_delta_log/00000000000000000007.checkpoint.parquet")
-- MAGIC display(x)
